<footer>
    <?php
    // only display the search form in the index and booking page
    $pageName = basename($_SERVER['PHP_SELF']);
    if (($pageName == 'booking.php') or ($pageName == 'index.php')) {
        include './findfooter.php';
    }
    ...
    <div>&copy;
        ...
        </script> Matthew Rohrich, Student Num. Last modified <?= date("Y F d  H:i", filemtime($_SERVER['SCRIPT_FILENAME'])); ?>.
